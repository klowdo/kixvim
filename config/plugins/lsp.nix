{pkgs, ...}: {
  ...
  plugins.lsp = {
    ...
    keymaps = {
      ...
      extra = [
        # NOTE: gd, gr, gI are handled by LSP Saga (see config/plugins/lsp/lsp-saga.nix)
      ...
      lspBuf = {
        # NOTE: K, <leader>ca, and rename are handled by LSP Saga
        # Rename the variable under your cursor.
        #  Most Language Servers support renaming across files, etc.
        # Use <leader>cr for LSP Saga rename
        # "<leader>rn" = {
        #   action = "rename";
        #   desc = "LSP: [R]e[n]ame";
        # };
